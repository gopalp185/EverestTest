...
public class LogsGenerator  {
	...
	public String logvalues(int count,String isbn, String bname, String pblsr,String author,String qty,String amznprice,boolean amznavl,String amznqty,String flpprice,boolean flpavl,String flpqty)
	{
		String logs=" ";
		try
		{
